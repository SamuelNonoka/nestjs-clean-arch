import { Controller, Get, Post, Body, Patch, Param, Put, Delete, Inject, HttpCode, Query } from '@nestjs/common';
...
import { ListUsersUseCase } from '../application/usecases/listuser.usecase';
